...
img_size = 256
no_of_channel = 3
training_set_path=r'C:\Users\Arun\Desktop\MachineLearning\Project\CNN\binary-classification\binary-dataset\training-data'
...
consolution_filter_size_1 = 3 
no_of_consolution_filter_1 = 32

consolution_filter_size_2 = 3
no_of_consolution_filter_2 = 32

consolution_filter_size_3 = 3
no_of_consolution_filter_3 = 64
...
def create_convolutional_layer(input,
    ...
    weights = assign_weights(shape=[convalidation_size, convalidation_size, no_of_channel, num_filters])
...
convolution_layer_1 = create_convolutional_layer(input=x,
               ...
               convalidation_size=consolution_filter_size_1,
               num_filters=no_of_consolution_filter_1)
convolution_layer_2 = create_convolutional_layer(input=convolution_layer_1,
               no_of_channel=no_of_consolution_filter_1,
               convalidation_size=consolution_filter_size_2,
               num_filters=no_of_consolution_filter_2)

convolution_layer_3= create_convolutional_layer(input=convolution_layer_2,
               no_of_channel=no_of_consolution_filter_2,
               convalidation_size=consolution_filter_size_3,
               num_filters=no_of_consolution_filter_3)
...
def train(num_iteration):
    ...
    for i in range(total_no_of_iter,
        ...
        if i % int(data.train.num_examples/b_size) == 0: 
            ...
            saver.save(session,r'C:\Users\Arun\Desktop\MachineLearning\Project\CNN\binary-classification\model') 
