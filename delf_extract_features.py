...
def _ReadImageList(list_path):
  ...
  for filename in os.listdir('D:\\Study\\sem3\\ml\\project\\files\\training-data\\train-class1'):
    image_paths.append(os.path.join("D:\\Study\\sem3\\ml\\project\\files\\training-data\\train-class1",filename))
